@foreach (['create' => 'Add New', 'edit' => 'Edit'] as $mode => $title)
    <div id="{{ $mode }}UserModal"
        ...
        <div class="flex justify-center items-center min-h-screen">
            ...
            <div class="relative p-6 border w-full max-w-[800px] shadow-lg rounded-md bg-white">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl font-semibold text-gray-900">{{ $title }} User</h3>
                    <button onclick="closeModal('{{ $mode }}UserModal')"
                ...
                <form id="{{ $mode }}UserForm" method="POST"
                    ...
                    <div class="flex justify-end mt-4 sm:mt-6 pt-4 border-t">
                        ...
                        <button type="submit"
                            class="bg-green-600 text-white px-3 sm:px-4 py-2 text-sm sm:text-base rounded-lg hover:bg-green-700">
